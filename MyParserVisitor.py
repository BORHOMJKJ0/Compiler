...
class MyParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MyParser#insertStatement.
    def visitInsertStatement(self, ctx:MyParser.InsertStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MyParser#insertColumns.
    def visitInsertColumns(self, ctx:MyParser.InsertColumnsContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MyParser#insertValues.
    def visitInsertValues(self, ctx:MyParser.InsertValuesContext):
        return self.visitChildren(ctx)
