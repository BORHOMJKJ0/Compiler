...
class MyParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MyParser#deleteStatement.
    def enterDeleteStatement(self, ctx:MyParser.DeleteStatementContext):
        pass

    # Exit a parse tree produced by MyParser#deleteStatement.
    def exitDeleteStatement(self, ctx:MyParser.DeleteStatementContext):
        pass
    ...
    # Enter a parse tree produced by MyParser#orderByClause.
    def enterOrderByClause(self, ctx:MyParser.OrderByClauseContext):
        pass

    # Exit a parse tree produced by MyParser#orderByClause.
    def exitOrderByClause(self, ctx:MyParser.OrderByClauseContext):
        pass


    # Enter a parse tree produced by MyParser#orderByItem.
    def enterOrderByItem(self, ctx:MyParser.OrderByItemContext):
        pass

    # Exit a parse tree produced by MyParser#orderByItem.
    def exitOrderByItem(self, ctx:MyParser.OrderByItemContext):
        pass
