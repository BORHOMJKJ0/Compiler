...
LPAREN: '(';
RPAREN: ')';
LOCAL: [lL][oO][cC][aA][lL] | '[' [lL][oO][cC][aA][lL] ']';
GLOBAL: [gG][lL][oO][bB][aA][lL] | '[' [gG][lL][oO][bB][aA][lL] ']';
FORWARD_ONLY: [fF][oO][rR][wW][aA][rR][dD] '_' [oO][nN][lL][yY] | '[' [fF][oO][rR][wW][aA][rR][dD] '_' [oO][nN][lL][yY] ']';
SCROLL: [sS][cC][rR][oO][lL][lL] | '[' [sS][cC][rR][oO][lL][lL] ']';
STATIC: [sS][tT][aA][tT][iI][cC] | '[' [sS][tT][aA][tT][iI][cC] ']';
KEYSET: [kK][eE][yY][sS][eE][tT] | '[' [kK][eE][yY][sS][eE][tT] ']';
DYNAMIC: [dD][yY][nN][aA][mM][iI][cC] | '[' [dD][yY][nN][aA][mM][iI][cC] ']';
FAST_FORWARD: [fF][aA][sS][tT] '_' [fF][oO][rR][wW][aA][rR][dD] | '[' [fF][aA][sS][tT] '_' [fF][oO][rR][wW][aA][rR][dD] ']';
READ_ONLY: [rR][eE][aA][dD] '_' [oO][nN][lL][yY] | '[' [rR][eE][aA][dD] '_' [oO][nN][lL][yY] ']';
SCROLL_LOCKS: [sS][cC][rR][oO][lL][lL] '_' [lL][oO][cC][kK][sS] | '[' [sS][cC][rR][oO][lL][lL] '_' [lL][oO][cC][kK][sS] ']';
OPTIMISTIC: [oO][pP][tT][iI][mM][iI][sS][tT][iI][cC] | '[' [oO][pP][tT][iI][mM][iI][sS][tT][iI][cC] ']';
NEXT: [nN][eE][xX][tT] | '[' [nN][eE][xX][tT] ']';
PRIOR: [pP][rR][iI][oO][rR] | '[' [pP][rR][iI][oO][rR] ']';
LAST: [lL][aA][sS][tT] | '[' [lL][aA][sS][tT] ']';
ABSOLUTE: [aA][bB][sS][oO][lL][uU][tT][eE] | '[' [aA][bB][sS][oO][lL][uU][tT][eE] ']';
RELATIVE: [rR][eE][lL][aA][tT][iI][vV][eE] | '[' [rR][eE][lL][aA][tT][iI][vV][eE] ']';
LINE_COMMENT: '--' ~[\r\n]* -> skip;
BLOCK_COMMENT: '/*' .*? '*/' -> skip;
WS: [ \t\r\n]+ -> skip;
